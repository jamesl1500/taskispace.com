    ...
    return (
        <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-gray-200 dark:bg-gray-900">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Pricing Cards */}
                <div className="flex flex-col md:flex-row gap-4 max-w-5xl mx-auto mb-20 justify-center items-stretch">
                    {/* Free Plan */}
                    <Card className="relative border-2 border-gray-200 dark:border-gray-700 flex flex-col">
                    ...
                    {/* Pro Plan */}
                    <Card className="relative border-2 border-blue-600 dark:border-blue-500 shadow-lg flex flex-col">
                ...
                <div className="mt-8 mb-8 max-w-3xl mx-auto">
                    <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-8 mt-8">
